...
public class MySubscriptionsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView backButton = findViewById(R.id.backicon9);
        ...
        LinearLayout eventCard = findViewById(R.id.card6);
        eventCard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MySubscriptionsActivity.this, AboutSubscriptionActivity.class);
                startActivity(intent);
            }
        });
    }
